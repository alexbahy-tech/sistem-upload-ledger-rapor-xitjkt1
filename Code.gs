 ...
 */
const CONFIG = {
  SHEET_ID: "1JzMR6BOJd74wGOiMpsZqCB1Ycun_3lipCPJNPY1NLvw", // ID Spreadsheet Database
  SHEET_NAME: "Sheet1",                                     // Nama Sheet
  PARENT_FOLDER_ID: "1mfeWFuU9azCUeeyxR0InsKExFzmucLJV",    // ID Folder Induk Siswa
  LEDGER_FOLDER_ID: "12b1fbMIv3ze_fqB7YKWSfxSesKecDCcc"     // ID Folder Ledger
};
